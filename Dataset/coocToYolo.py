...
if __name__ == "__main__":
    base_input_path = "/Users/mu7annad.0gmail.com/Documents/gradDataset/aerial/"
    base_output_path = "/Users/mu7annad.0gmail.com/Documents/GitHub/SegmentAnySatelliteImage/Dataset/yolo_dataset"

    # Processing validation dataset (if needed)
    convert_to_yolo(
        input_images_path=os.path.join(base_input_path, "valid"),
        input_json_path=os.path.join(base_input_path, "valid/valid.json"),
